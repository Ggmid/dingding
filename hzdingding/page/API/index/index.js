...
if (dd.canIUse('multiLevelSelect')) {
...
if (dd.canIUse('getScreenBrightness')) {
  lastOpenDeviceList.push({
    title: '屏幕亮度',
...
if (dd.canIUse('textRiskIdentification')) {
    ...
    arr: {
      ...
      list: [{
        ...
        subs: [{
          ...
          title: '电话',
          entitle: 'callUsers/showCallMenu/checkBizCall',
          page: '../phone/phone'
        }
          // {
          //   title: '获取用户信息',
        ...
        // }, 
        {
          ...
          entitle: 'navigateTo, navigateBack, switchTab',
